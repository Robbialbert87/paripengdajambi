            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                                    Kelola data dan barcode Tanda Tangan
                                    Elektronik
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center gap-4 px-5 py-6">
                                <div
                                    ref={canvasRef}
                                    className="rounded-lg border border-neutral-100 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-neutral-900"
                                >
                                    <QRCodeCanvas
                                        key={key}
                                        value={previewUrl}
                                ...
                                <div className="flex w-full flex-col gap-2">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex w-full items-center justify-center gap-x-2 rounded-lg border border-neutral-300/60 bg-white/50 px-3 py-2 text-xs font-bold text-neutral-700 transition duration-300 hover:bg-neutral-200/80 dark:border-white/10 dark:bg-neutral-700/30 dark:text-neutral-300 dark:hover:bg-neutral-700"
                                    >
                            ...
                            <div className="border-t border-neutral-100 bg-neutral-50 px-5 py-2 text-center dark:border-white/10 dark:bg-neutral-900/40">
                ...
                <div>
                    <div className="overflow-hidden rounded-2xl border border-neutral-300/60 bg-neutral-100 backdrop-blur-md dark:border-white/10 dark:bg-white/[.075]">
                        <div className="border-b border-neutral-300/60 px-6 py-4 dark:border-white/10">
                        ...
                        {records.length === 0 ? (
                            ...
                            <div className="divide-y divide-neutral-100 dark:divide-neutral-700/40">
                                {records.map((record) => (
                                    <div
                                        key={record.id}
                                        className={`px-6 py-4 transition hover:bg-neutral-200/60 dark:hover:bg-neutral-700/20 ${
                                            record.is_active
