...
const steps = [
    { key: 1, label: 'Data Diri', icon: UserRound, description: 'Identitas pribadi' },
    { key: 2, label: 'Data Pekerjaan', icon: Stethoscope, description: 'STR & tempat kerja' },
    { key: 3, label: 'Data Pendidikan', icon: GraduationCap, description: 'Ijazah & keahlian' },
];
...
export default function Registrasi({
    ...
    const collegeGroups = useMemo(() => {
        const order = ['politeknik', 'universitas', 'institut', 'sekolah_tinggi', 'akademi'];
        ...
        return order
            .map((kind) => ({
                ...
                items: educationColleges.filter((college) => college.kind === kind),
            }))
                    ...
                    <div className="space-y-4">
                        <div className="rounded-2xl border border-neutral-300/60 bg-neutral-100 p-6 dark:border-white/10 dark:bg-white/[.075]">
                            ...
                            <ul className="mt-4 space-y-3 text-sm text-neutral-600 dark:text-neutral-400">
                                ...
                                <li className="flex gap-3">
                                    <CheckCircle2 className="mt-0.5 size-4 shrink-0 text-orange-400" />
                                    Siapkan scan ijazah PDF (maks 500 KB) dan pas
                                    foto memakai jas PARI.
                                </li>
                                <li className="flex gap-3">
                                    <CheckCircle2 className="mt-0.5 size-4 shrink-0 text-orange-400" />
                                ...
                                <>
                                    ...
                                    {/* STEP 1 — Data Diri */}
                                        ...
                                        >
                                            ...
                                            <div>
                                                <label htmlFor="home_address" className={labelClass}>
                                            ...
                                            <div className="grid gap-5 sm:grid-cols-2">
                                                <div>
                                                    <label htmlFor="nir" className={labelClass}>
                                                        NIR / Nomor Identitas Radiografer
                                                    </label>
                                                    <input
                                                        id="nir"
                                                        name="nir"
                                                ...
                                                <div className="flex items-center gap-4 rounded-xl border border-dashed border-neutral-300 bg-white/60 p-4 dark:border-neutral-700 dark:bg-neutral-900/40">
                                                    ...
                                                    <div className="grid gap-2">
                                                        ...
                                                        <p className="flex items-center gap-1.5 text-[11px] text-neutral-400 dark:text-neutral-500">
                                                            ...
                                                            JPG / PNG / GIF / WebP, maks 5 MB. Gunakan jas PARI dengan background merah.
                                                        </p>
                                                    </div>
                                                </div>
                                                {errors.photo && (
                                        ...
                                        >
                                            ...
                                            <div className="grid gap-5 sm:grid-cols-2">
                                                ...
                                                <div data-step="2">
                                                    <label htmlFor="instansi_id" className={labelClass}>
                                                    ...
                                                    />
                                                    {(instansiError || errors.instansi_id) && (
                                                        <p className="mt-1 text-xs text-red-500">
                                                            {instansiError ?? errors.instansi_id}
                                                        </p>
                                                    )}
                                            ...
                                            <div className="grid gap-5 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    <label htmlFor="str_status" className={labelClass}>
                                                        Status STR
                                                    </label>
                                                    <select
                                                        id="str_status"
                                        ...
                                        >
                                            ...
                                            <div>
                                                <label htmlFor="education_college_id" className={labelClass}>
                                            ...
                                            <div>
                                                <label htmlFor="diploma_file" className={labelClass}>
                                                    Scan Ijazah
                                                </label>
                                                <div className="flex items-center gap-4 rounded-xl border border-dashed border-neutral-300 bg-white/60 p-4 dark:border-neutral-700 dark:bg-neutral-900/40">
