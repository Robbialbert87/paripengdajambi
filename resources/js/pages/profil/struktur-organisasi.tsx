...
function ChairmanCard({ chairman }: { chairman: Person }) {
    return (
        <div className="mx-auto max-w-sm">
            <div className="group relative overflow-hidden rounded-2xl border-2 border-teal-300/50 bg-gradient-to-br from-neutral-100 to-white p-6 text-center shadow-lg shadow-teal-400/10 backdrop-blur-md transition-all duration-200 hover:-translate-y-1 hover:shadow-xl dark:border-teal-600/40 dark:from-neutral-800 dark:to-neutral-900 dark:shadow-teal-500/10">
                <div className="absolute -top-8 -right-8 size-24 rounded-full bg-teal-400/10 dark:bg-teal-500/10" />
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <h1 className="text-3xl font-bold tracking-tight text-neutral-800 sm:text-4xl dark:text-neutral-200">
                        Struktur Organisasi
                    </h1>
                    ...
                    <p className="mx-auto mt-2 max-w-xl text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">
                        Susunan kepengurusan Persatuan Radiografer Indonesia
